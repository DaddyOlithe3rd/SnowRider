...
public class PatAi : MonoBehaviour
{
    float moveInput;
    ...
    void Start()
    {
        ...
        obstacleRayDistance = speed / 2f;
        obstacleFeetRayDistance = speed / 2f;
        obstacleUncrouchRayDistance = 0.85f;
        obstacleUncrouchFrontRayDistance = 0.85f;
        scaleChangetoCrouch = new Vector3(1, 1.5f, 1);
        scaleChangetoStand = new Vector3(1, 2, 1);
    }
    ...
    private void Update()
    {
        ...
        if (hitObstacleHead.collider != null)
        {
            ...
            transform.localScale = scaleChangetoCrouch;
        }
